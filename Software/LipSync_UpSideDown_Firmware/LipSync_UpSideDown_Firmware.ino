...
//Firmware : LipSync_UpSideDown_Firmware
//VERSION: 2.7 (16 September 2019)
// modified for Joe to be upside down - scruss, 2020-07
...
*/
/* directions swapped for Joe */
#define X_DIR_HIGH_PIN A1                         // X Direction High (Cartesian positive x : right) - analog input pin A0
#define X_DIR_LOW_PIN A0                          // X Direction Low (Cartesian negative x : left) - digital output pin A1
#define Y_DIR_HIGH_PIN A10                         // Y Direction High (Cartesian positive y : up) - analog input pin A2
#define Y_DIR_LOW_PIN A2                         // Y Direction Low (Cartesian negative y : down) - analog input pin A10
